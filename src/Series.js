...
function Series({ name, folder, primary, background }) {
  ...
  else if (folder === "toilet")
    images = require.context("./icons/toilet", true);
  else if (folder === "bath") images = require.context("./icons/bath", true);
  else if (folder === "living")
    images = require.context("./icons/living", true);
  ...
  else if (folder === "museum")
    images = require.context("./icons/museum", true);
  else if (folder === "@work") images = require.context("./icons/@work", true);
  else if (folder === "dressing")
    images = require.context("./icons/dressing", true);
  else if (folder === "exercising")
    images = require.context("./icons/exercising", true);
  else if (folder === "moving")
    images = require.context("./icons/moving", true);
